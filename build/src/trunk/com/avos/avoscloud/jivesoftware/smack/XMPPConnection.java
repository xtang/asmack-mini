...
package com.avos.avoscloud.jivesoftware.smack;
...
import com.avos.avoscloud.jivesoftware.smack.compression.XMPPInputOutputStream;
import com.avos.avoscloud.jivesoftware.smack.filter.PacketFilter;
import com.avos.avoscloud.jivesoftware.smack.packet.Packet;
import com.avos.avoscloud.jivesoftware.smack.packet.Presence;
import com.avos.avoscloud.jivesoftware.smack.packet.XMPPError;
import com.avos.avoscloud.jivesoftware.smack.parsing.ParsingExceptionCallback;
import com.avos.avoscloud.jivesoftware.smack.util.StringUtils;
import com.avos.avoscloud.jivesoftware.smack.util.dns.HostAddress;
		...
		while (it.hasNext()) {
			...
			try {
				...
				String errorMessage = "XMPPError connecting to " + host + ":"
						+ port + ".";
				exception = new XMPPException(errorMessage, new XMPPError(
						XMPPError.Condition.remote_server_error, errorMessage),
						ioe);
				xmppIOError = true;
			}
			if (exception == null) {
